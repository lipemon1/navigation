...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, dueling=False, double=False):
        ...
        ======
            ...
            dueling (bool): if 'True' use dueling agent
            double (bool): if 'True' use double DDQN agent
        """
